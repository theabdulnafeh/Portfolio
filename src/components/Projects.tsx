...
export default function Projects() {
  ...
  return (
    <section
      id="projects"
      className="absolute top-[285vh] sm:top-[295vh] left-1/2 -translate-x-1/2 w-[90%] max-w-6xl z-20 flex flex-col items-center justify-center font-[family-name:var(--font-montserrat)] text-white scroll-mt-28 pb-16"
    >
